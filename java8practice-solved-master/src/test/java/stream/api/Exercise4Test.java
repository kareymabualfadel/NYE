...
public class Exercise4Test extends ClassicOnlineStore {
    ...
    public void firstRegistrant() {
         ...
         */
        Optional<Customer> firstCustomer =
                customerList.stream().findFirst();
    ...
    public void isThereAnyoneOlderThan40() {
         ...
         */
        boolean olderThan40Exists =
                customerList.stream().anyMatch(c -> c.getAge() > 40);
    ...
    public void isEverybodyOlderThan20() {
         ...
         */
        boolean allOlderThan20 =
                customerList.stream().allMatch(c -> c.getAge() > 20);
    ...
    public void everyoneWantsSomething() {
         ...
         */
        boolean everyoneWantsSomething =
                customerList.stream().noneMatch(c -> c.getWantToBuy().isEmpty());
